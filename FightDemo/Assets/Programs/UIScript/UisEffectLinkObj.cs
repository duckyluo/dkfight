...
public class UisEffectLinkObj : MonoBehaviour
{
	public int zigs = 100;
	public float speed = 1f;
	public float scale = 1f;

	protected Transform m_targetA;
	protected Transform m_targetB;

	protected Vector3 m_aOffset = Vector3.zero;

	protected Perlin noise;
	protected float oneOverZigs;
...
//	}
	...
	public void Initlize(Transform targetA , Transform targetB , Vector3 offset)
	{
		m_targetA = targetA;
		m_targetB = targetB;
		m_aOffset = offset;
	...
	public void UpdateEffect ()
	{
		...
		{
			Vector3 position = Vector3.Lerp(m_targetA.position+m_aOffset, m_targetB.position+m_aOffset, oneOverZigs * (float)i);
